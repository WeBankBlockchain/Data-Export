...
public class MethodParser {
    ...
    public static List<MethodMetaInfo> parseToInfoList(String abiStr, String contractName,ServiceConfig config) {
        ...
        for (ABIDefinition abiDefinition : abiDefinitions) {
            ...
            method.setFieldsList(getFieldList(inputs,method.getMethodName(),contractName,config))
                    .setOutputList(getOutputList(outputs,method.getMethodName(),contractName,config));
            lists.add(method);
        }
        return lists;
    }
